...
export const galleryItems: GalleryItem[] = [
  ...
  {
    id: 'malabar-walk-trip-1',
    src: '/gallery/malabar-walk-trip-1.webp',
    alt: 'Portrait sitting on a concrete ledge against an overcast sky',
    caption: 'Low-angle portrait against the sky on the Malabar headland walk.',
    category: 'photography',
    aspect: 'square',
  },
  {
    id: 'malabar-walk-trip-2',
    src: '/gallery/malabar-walk-trip-2.webp',
    alt: 'Sitting on a graffitied concrete lookout above the ocean at dusk',
    caption: 'Watching the swell from the old lookout at Malabar — pastel dusk over the Pacific.',
    category: 'photography',
    aspect: 'portrait',
  },
  {
    id: 'malabar-walk-trip-13',
    src: '/gallery/malabar-walk-trip-13.webp',
    alt: 'Side profile gazing out to sea from a graffitied ledge at sunset',
    caption: 'Golden hour on the Malabar coastal walk, perched above the water.',
    category: 'photography',
    aspect: 'portrait',
  },
  {
    id: 'maroubara-beach-trip',
    src: '/gallery/maroubara-beach-trip.webp',
    alt: 'Friends silhouetted against a sunset sky beside a tidal stream at Maroubra Beach',
    caption: 'Silhouettes at sundown — shot from water level at Maroubra Beach.',
    category: 'photography',
    aspect: 'square',
  },
]
